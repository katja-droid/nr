...
const Footer = () => {
  ...
  const icons = [
    { imgSrc: linkedin, alt: 'LinkedIn', link: 'https://linkedin.com' },
    { imgSrc: telegram, alt: 'Telegram', link: 'https://telegram.com' },
    { imgSrc: facebook, alt: 'Facebook', link: 'https://facebook.com' },
    { imgSrc: dribbble, alt: 'Dribbble', link: 'https://dribbble.comm' },
  ];
